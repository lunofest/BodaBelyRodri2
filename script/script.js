...
function updateTimer() {
    const targetDate = new Date("may 11, 2025 13:00:00").getTime();
...
function eliminarAcentos(texto) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const botonPrecio = document.getElementById('mostrarBotonPrecio');
    const textoDesplegablePrecio = document.getElementById('textoDesplegablePrecio');
  
    botonPrecio.addEventListener('click', function () {
      textoDesplegablePrecio.classList.toggle('mostrar');
    });
});
  
function copyTextPrecio() {
    var aliasText = document.getElementById('aliasPrecio').innerText;
    var tempInput = document.createElement('input');
    tempInput.value = aliasText;
    document.body.appendChild(tempInput);
    tempInput.select();
    ...
    // Mostrar el mensaje de "¡Copiado!"
    var copyMessage = document.getElementById('copyMessagePrecio');
    copyMessage.style.display = 'block';
    setTimeout(function() {
        copyMessage.style.display = 'none';
    }, 1500);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '543814756992'; // Número para el primer botón
    const recipientNumber2 = '543816981966'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function() {
    // Definir los números de teléfono
    const phoneNumber1 = '543814756992'; // Número para el primer botón
